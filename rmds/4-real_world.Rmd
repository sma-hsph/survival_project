...
tb_summary <- tb_fits %>% 
  ...
  dplyr::mutate(
    ...
    var_total = results[[1]]$fit_marginal$Sigma[3, 3],
    coef_direct = results[[1]]$fit_opt$coef[3],
    var_direct = results[[1]]$fit_opt$Sigma[3, 3],
    coef_indirect = results[[1]]$fit_opt$coef_indirect[3],
    var_indirect = results[[1]]$fit_opt$Sigma_indirect[3, 3],
    coef_conditional = results[[1]]$fit_opt$coef[4],
    var_conditional = results[[1]]$fit_opt$Sigma[4, 4],
    coef_alpha = results[[1]]$fit_opt$coef_alpha[3],
    var_alpha = results[[1]]$fit_opt$Sigma_alpha[3, 3]) %>% 
  dplyr::ungroup() %>% 
