...
dir_output <- "../survival_paper/results/2-run_estimators/"
dir.create(dir_output, recursive = TRUE, showWarnings = FALSE)
library(magrittr)
```
```{r load datasets}
load("../survival_paper/results/1-simulate_datasets/scenarioI.RData")
load("../survival_paper/results/1-simulate_datasets/scenarioII.RData")
load("../survival_paper/results/1-simulate_datasets/scenarioIII.RData")
