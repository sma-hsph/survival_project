...
percCens <- tibble::tibble(percCens = list(c(0.2, 0.2),
                                           c(0.4, 0.4)))
# true coefficients
b <- tibble::tibble(b = list(c(2, 0),
                             c(2, 2),
                             c(2, 4)))
a <- tibble::tibble(a = list(matrix(2, nrow = 1, ncol = 1)))
...
tb_eT <- tibble::tibble(dist_eT = list(c("normal", "evd", "normal", "evd"),
                        ...
                        sd_eT = list(c(1, 1, 1, 1),
                                     ...
                                     c(1, 1, 1, 1)))
# percentage censoring
percCens <- tibble::tibble(percCens = list(c(0.2, 0.2, 0.2, 0.2)))
# true coefficients
b <- tibble::tibble(b = list(c(2, 2)))
a <- tibble::tibble(a = list(matrix(2, nrow = 1, ncol = 1)))
